    ...
    <div>
      ...
      <header className="container mx-auto mt-20 py-[48px]">
        ...
        <h1 className="py-[24px] text-[2.25rem] font-bold leading-[2.5rem] tracking-[-.025em] text-[#0f172a]">
          Online resources for Frontend Developers.
        </h1>
      ...
      <nav className="container sticky -top-1 md:top-24 z-50 mx-auto h-full overflow-x-scroll bg-white bg-opacity-50 py-2 md:py-4 backdrop-blur-sm">
