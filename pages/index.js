...
export default function Home() {
  ...
  return (
    <div>
      ...
      <header className="container mx-auto bg-[url('https://assets-global.website-files.com/5ce10a4c0b5f0b05f522e746/61f9aaf3889ff64e10afad3e_bg-blur-colors-top-light.jpg')] pb-[48px] !pt-[calc(5rem_+_48px)]">
        <div className="flex items-center space-x-3">
          <p className="text-sm font-normal text-gray-500">288 resource</p>
          <svg
            viewBox="0 0 2 2"
            aria-hidden="true"
            className="w-0.5 fill-current text-gray-500"
          >
            <circle cx="1" cy="1" r="1"></circle>
          </svg>
          <p className="text-sm font-normal text-gray-500">MIT license</p>
        </div>
