...
const Navbar = () => {
  return (
    <nav className="container fixed top-0 left-1/2 z-50 mx-auto -translate-x-1/2 transform border-y border-slate-200 bg-white py-2.5 filter backdrop-blur dark:bg-slate-900 md:py-4">
