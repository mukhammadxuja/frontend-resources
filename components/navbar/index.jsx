...
const Navbar = () => {
  return (
    <nav className="container fixed top-0 z-50 left-1/2 transform -translate-x-1/2 mx-auto border-y border-slate-200 bg-white py-2.5 filter backdrop-blur dark:bg-slate-900 md:py-4">
