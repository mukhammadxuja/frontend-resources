export const data = [
  ...
  // ------------- Tools --------------- //
  {
    ...
    link: 'https://reactjs.org/',
    colors: {
      tagColors: 'bg-blue-200 text-blue-500 hover:bg-blue-100',
  ...
  },
  {
    ...
    hashtags: ['popular', 'tools', 'easy to learn'],
    trend: {
      like: 0,
      favorite: true,
    },
  },
  {
    ...
    hashtags: ['popular', 'tools', 'hard to learn'],
    trend: {
      like: 0,
      favorite: true,
    },
  },
  {
    ...
    tag: 'Tools',
    description:
      'Svelte is an frontend framework for creating interactive UIs.',
  ...
  },
  {
    id: 2.3,
    name: 'Bootstrap',
    image: '/images/style/bootstrap.svg',
    tag: 'Style',
